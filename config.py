...
# Bot Information
API_ID = int(environ.get("28575202", ""))
API_HASH = environ.get("1b67159ec6b7d40313ee851dd76fdb16", "")
BOT_TOKEN = environ.get("BOT_TOKEN", "")

PICS = (environ.get('PICS', 'https://graph.org/file/8b99ae45f78ba1eed0a52.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6763996948').split()]
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002176164478"))
